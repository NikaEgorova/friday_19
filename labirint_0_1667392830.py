...
background = transform.scale(image.load('bg.png'), (window_width, window_height))
...
wall1 = GameSprite('wall1.png', 400, 0, 25, 175)
wall2 = GameSprite('wall2.png', 200, 150, 200, 25)
wall3 = GameSprite('wall2.png', 550, 300, 150, 25)
wall4 = GameSprite('wall1.png', 200, 380, 25, 150)
wall5 = GameSprite('wall2.png', 550, 150, 150, 25)
wall6 = GameSprite('wall1.png', 200, -50, 20, 100)
...
monster = Enemy('enemy.png', 450, 400, 80, 80, 3)
monstr = Enemy1('enemy.png', 100, 225, 80, 80, 3)
monstryk = GameSprite('enemy.png', 250, 80, 80, 80)
finish = GameSprite('end.png', 550, window_height -500, 100, 80)
